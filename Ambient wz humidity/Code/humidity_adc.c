...
---------------------------------------------------------------------------------*/
void humidity_adc_init()
{
   PINSEL1_bit.P0_30 = 1; //set bit 28 PIO0 as analog input (channel-1)
         
   AD0CR_bit.SEL = 0x08;  //Conversion to be done on channel-1 only
...
------------------------------------------------------------------------------------------------*/
unsigned short read_humidity()//
{
   unsigned short digital_value;
   
   AD0CR_bit.SEL = 0x08; //equal to 00000100 with respect to each bit //(1<<channel);    //Conversion to be done on selected channel
   ...
   digital_value=1023-digital_value; //adjustment to match the percent on the potentiometer
   
   digital_value*=100;          //adjustments to convert into percent
